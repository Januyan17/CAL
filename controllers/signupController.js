...
function signupSchema(req, res, next) {
  const schema = Joi.object({
    ...
    index_no: Joi.optional(),
    year: Joi.optional(),
    role_id: Joi.number(),
    university: Joi.string().required(),
    first_name: Joi.string().required(),
    last_name: Joi.string().required(),
    phone_num1: Joi.string().required(),
    phone_num2: Joi.optional(),
...
async function signup(req, res, next) {
  ...
  var transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
      user: 'seralaganmathusan1@gmail.com',
      pass: 'iketniwulmndnpac',
    },
  });

  var mailOptions = {
    from: 'seralaganmathusan1@gmail.com',
